...
<%
  // Récupération du paramètre (id) passé par l'URL : http://localhost:8080/infos_candidatures.jsp?id=1
        ...
        int id = Integer.parseInt(idString);
		    ...
		    <table id="affichage">
		      ...
		      <tr>
		        <th>Descriptif :</th>
		        <td>
		          <%=Utils.text2HTML(candidature.getCurriculumvitae())%>
		        </td>
		      </tr>
		      <tr>
