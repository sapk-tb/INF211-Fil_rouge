...
public class EntrepriseDAO {
	...
	public List<Entreprise> findAll() {
		Query query = entityManager
				.createQuery("select entreprise from Entreprise entreprise order by entreprise.idEnt");
	...
	public Entreprise update(Entreprise entreprise) {
		Entreprise e = entityManager.merge(entreprise);
		return e;
	}
	// -----------------------------------------------------------------------------
	public void remove(Entreprise entreprise) {
		if(!entityManager.contains(entreprise)) entreprise = entityManager.merge(entreprise);
